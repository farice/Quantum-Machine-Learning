...
\subsection{Least-Square Sample Generation}
...
\subsection{Application: Stochastic Regression}
...
\begin{proof}
	Let random variable $h(B) \in \{0, 1\}^d$ be the hypothesis that the learner produces (given
the examples in $B$) restricted to the elements $s_1,\cdots ,s_d$. Note that the error of the hypothesis
\end{proof}
\end{lemma}
