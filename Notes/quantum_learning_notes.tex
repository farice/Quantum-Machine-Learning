...
Consider attempting to distinguish two pure states $\ket{\psi_0,\psi_1}$. Then, we will distinguish correctly with probability at most $1/2[1 + \sqrt{1 - |\bra{\psi_0}\ket{\psi_1}}|^2}]$.
...
T(\ket{\psi_0}\bra{\psi_0}, \ket{\psi_1}\bra{\psi_1}	) &= 1/2\Tr(\ket{\psi_0}\bra{\psi_0} - 2\ket{\psi_0}\bra{\psi_0}\ket{\psi_1}\bra{\psi_1} + \ket{\psi_1}\bra{\psi_1})\\
&= 1/2\Tr(\ket{\psi_0}\bra{\psi_0}) - 1\Tr(\ket{\psi_0}\bra{\psi_0}\ket{\psi_1}\bra{\psi_1}) + 1/2\Tr(\ket{\psi_1}\bra{\psi_1}) \\
&= 1/2 + 1/2 - \Tr(\ket{\psi_0}\bra{\psi_0}\ket{\psi_1}\bra{\psi_1}) \\
&= 1 - \Tr(\bra{\psi_0}\ket{\psi_1}\bra{\psi_1}\ket{\psi_0}) \\
