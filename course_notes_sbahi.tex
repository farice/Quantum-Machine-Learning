...
Hence, ignoring the normalization factor

\begin{align*}
	( I + iX)( I + iZ)( I + iX) &= I + iX + iZ + i^2ZX + iX + i^2X^2 + i^2XZ + i^3XZX \\
	&= I + iX + iZ - ZX  + iX - I - XZ + i^3 XZX \\
	&= i (X + Z)  + iX -i XZX \\
	&= i(X + Z) + iX + iZ \\
	&= 2i(X + Z)
\end{align*}

which gives the Hadamard transform up to a global phase. 
